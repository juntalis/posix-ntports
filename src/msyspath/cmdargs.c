/*
  ...
  g:\cpp.workspace\ln-win\libexec\gengetopt.exe --input=cmdargs.ggo --file-name=cmdargs -G -u
...
const char *gengetopt_args_info_purpose = "Simple implementation of some of the functionality of cygpath for msys.\nConvert Unix and Windows format paths.";

const char *gengetopt_args_info_usage = "Usage: msyspath.exe (-m|-u|-w) [OPTIONS] [-f] path";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -u, --unix      print Unix form of NAMEs (/cygdrive/c/winnt)",
  "\n Path conversion options:",
  "  -a, --absolute  output absolute path",
  "  -p, --path      NAME is a PATH list (i.e., '/bin:/usr/bin')",
  "\n Other options:",
  "  -f, --file      read path for input; use - to read from STDIN",
    0
};
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->windows_given = 0 ;
  args_info->mixed_given = 0 ;
  args_info->unix_given = 0 ;
  args_info->absolute_given = 0 ;
  args_info->path_given = 0 ;
  args_info->file_given = 0 ;
  args_info->Output_type_options_group_counter = 0 ;
}
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->windows_help = gengetopt_args_info_help[2] ;
  args_info->mixed_help = gengetopt_args_info_help[3] ;
  args_info->unix_help = gengetopt_args_info_help[4] ;
  args_info->absolute_help = gengetopt_args_info_help[6] ;
  args_info->path_help = gengetopt_args_info_help[7] ;
  args_info->file_help = gengetopt_args_info_help[9] ;
...
cmdline_parser_file_save(const char *filename, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->windows_given) {
    fprintf(outfile, "%s\n", "windows");
  }
  if (args_info->mixed_given) {
    fprintf(outfile, "%s\n", "mixed");
  }
  if (args_info->unix_given) {
    fprintf(outfile, "%s\n", "unix");
  }
...
static void
reset_group_Output_type_options(struct gengetopt_args_info *args_info);

static void
reset_group_Output_type_options(struct gengetopt_args_info *args_info)
{
  if (! args_info->Output_type_options_group_counter)
    return;
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (args_info->Output_type_options_group_counter == 0)
    {
      fprintf (stderr, "%s: %d options of group Output type options were given. One is required.%s\n", prog_name, args_info->Output_type_options_group_counter, (additional_error ? additional_error : ""));
      error = 1;
    }
...
cmdline_parser_internal (int argc, char * const *argv, struct gengetopt_args_info *args_info, int override, int initialize, int check_required, const char *additional_error)
{
  ...
  while (1)
    {
      ...
      c = custom_getopt_long (argc, argv, "hVwmuapf", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'w':	/* print Windows form of NAMEs (C:\\WINNT).  */
          if (local_args_info.windows_given)
            {
              fprintf (stderr, "%s: `--windows' (`-w') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
              goto failure;
            }
          if (args_info->windows_given && ! override)
            continue;
          local_args_info.windows_given = 1;
          args_info->windows_given = 1;
          if (args_info->Output_type_options_group_counter && override)
            reset_group_Output_type_options (args_info);
          args_info->Output_type_options_group_counter += 1;
          break;

        case 'm':	/* like --windows, but with regular slashes (C:/WINNT).  */
          if (local_args_info.mixed_given)
            {
              fprintf (stderr, "%s: `--mixed' (`-m') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
              goto failure;
            }
          if (args_info->mixed_given && ! override)
            continue;
          local_args_info.mixed_given = 1;
          args_info->mixed_given = 1;
          if (args_info->Output_type_options_group_counter && override)
            reset_group_Output_type_options (args_info);
          args_info->Output_type_options_group_counter += 1;
          break;

        case 'u':	/* print Unix form of NAMEs (/cygdrive/c/winnt).  */
          if (local_args_info.unix_given)
            {
              fprintf (stderr, "%s: `--unix' (`-u') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
              goto failure;
            }
          if (args_info->unix_given && ! override)
            continue;
          local_args_info.unix_given = 1;
          args_info->unix_given = 1;
          if (args_info->Output_type_options_group_counter && override)
            reset_group_Output_type_options (args_info);
          args_info->Output_type_options_group_counter += 1;
          break;

        case 'a':	/* output absolute path.  */
          if (local_args_info.absolute_given)
            {
              fprintf (stderr, "%s: `--absolute' (`-a') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
              goto failure;
            }
          if (args_info->absolute_given && ! override)
            continue;
          local_args_info.absolute_given = 1;
          args_info->absolute_given = 1;
          break;

        case 'p':	/* NAME is a PATH list (i.e., '/bin:/usr/bin').  */
        ...
        case 'f':	/* read FILE for input; use - to read from STDIN.  */
  ...
  if (args_info->Output_type_options_group_counter > 1)
    {
      fprintf (stderr, "%s: %d options of group Output type options were given. One is required.%s\n", argv[0], args_info->Output_type_options_group_counter, (additional_error ? additional_error : ""));
      error = 1;
    }
