/*
  ...
  ..\..\libexec\gengetopt.exe -i lnargs.ggo --file-name=lnargs -G -u
...
const char *gengetopt_args_info_purpose = "Native Win32 port of the GNU ln tool for creating symbolic/hardlinks.";
...
const char *gengetopt_args_info_help[] = {
	...
	"\n Options:",
	"  -d, --directory               make a junction to a directory",
	...
	"  -t, --target-directory=STRING specify the DIRECTORY in which to create the \n                                  links",
	"  -T, --no-target-directory     treat LINK_NAME as a normal file",
	"  -V, --verbose                 print name of each linked file",
	"\n Cygwin-Specific Options:",
	"  -c, --cyglink                 Create a cygwin symbolic link instead of a \n                                  native Win32 symbolic link. (Assumes -s)\n",
	" Report winln bugs to the project site: <https://github.com/Juntalis/ln-win32>",
	0
};
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->target_directory_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->logical_help = gengetopt_args_info_help[5] ;
  args_info->no_dereference_help = gengetopt_args_info_help[6] ;
  args_info->physical_help = gengetopt_args_info_help[7] ;
  args_info->symbolic_help = gengetopt_args_info_help[8] ;
  args_info->target_directory_help = gengetopt_args_info_help[9] ;
  args_info->no_target_directory_help = gengetopt_args_info_help[10] ;
  args_info->verbose_help = gengetopt_args_info_help[11] ;
  args_info->cyglink_help = gengetopt_args_info_help[13] ;
...
{
  printf ("%s %s", CMDLINE_PARSER_PACKAGE, CMDLINE_PARSER_VERSION);
}
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  unsigned int i;
  if (args_info->target_directory_arg)
	{
	  free (args_info->target_directory_arg); /* free previous argument */
	  args_info->target_directory_arg = 0;
	}
  if (args_info->target_directory_orig)
	{
	  free (args_info->target_directory_orig); /* free previous argument */
	  args_info->target_directory_orig = 0;
	}
...
cmdline_parser_file_save(const char *filename, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->logical_given) {
	fprintf(outfile, "%s\n", "logical");
  }
  if (args_info->no_dereference_given) {
	fprintf(outfile, "%s\n", "no-dereference");
  }
  if (args_info->physical_given) {
	fprintf(outfile, "%s\n", "physical");
  }
  ...
  if (args_info->target_directory_given) {
	if (args_info->target_directory_orig) {
	  fprintf(outfile, "%s=\"%s\"\n", "target-directory", args_info->target_directory_orig);
	} else {
	  fprintf(outfile, "%s\n", "target-directory");
	}
  }
  ...
  while (1)
	{
	  ...
	  c = custom_getopt_long (argc, argv, "hdfiLnPst:TVc", long_options, &option_index);
	  ...
	  switch (c)
		...
		case 'd':	/* make a junction to a directory.  */
		...
		case 'f':	/* remove existing destination files.  */
		  if (local_args_info.force_given)
			{
			  fprintf (stderr, "%s: `--force' (`-f') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
			  goto failure;
			}
		...
		case 'i':	/* prompt whether to remove destinations.  */
		  if (local_args_info.interactive_given)
			{
			  fprintf (stderr, "%s: `--interactive' (`-i') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
			  goto failure;
			}
		  if (args_info->interactive_given && ! override)
			continue;
		  local_args_info.interactive_given = 1;
		  args_info->interactive_given = 1;
		  break;

		case 'L':	/* make hard links to symbolic link references.  */
		  if (local_args_info.logical_given)
			{
			  fprintf (stderr, "%s: `--logical' (`-L') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
			  goto failure;
			}
		  if (args_info->logical_given && ! override)
			continue;
		  local_args_info.logical_given = 1;
		  args_info->logical_given = 1;
		  break;

		case 'n':	/* treat destination that is a symlink to a directory as if it were a normal file.  */
		  if (local_args_info.no_dereference_given)
			{
			  fprintf (stderr, "%s: `--no-dereference' (`-n') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
			  goto failure;
			}
		  if (args_info->no_dereference_given && ! override)
			continue;
		  local_args_info.no_dereference_given = 1;
		  args_info->no_dereference_given = 1;
		  break;

		case 'P':	/* make hard links directly to symbolic links.  */
		  if (local_args_info.physical_given)
			{
			  fprintf (stderr, "%s: `--physical' (`-P') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
			  goto failure;
			}
		  if (args_info->physical_given && ! override)
			continue;
		  local_args_info.physical_given = 1;
		  args_info->physical_given = 1;
		  break;

		case 's':	/* make symbolic links instead of hard links.  */
		  if (local_args_info.symbolic_given)
			{
			  fprintf (stderr, "%s: `--symbolic' (`-s') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
			  goto failure;
			}
		  if (args_info->symbolic_given && ! override)
			continue;
		  local_args_info.symbolic_given = 1;
		  args_info->symbolic_given = 1;
		  break;

		case 't':	/* specify the DIRECTORY in which to create the links.  */
		  if (local_args_info.target_directory_given)
			{
			  fprintf (stderr, "%s: `--target-directory' (`-t') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
			  goto failure;
			}
		  if (args_info->target_directory_given && ! override)
			continue;
		  local_args_info.target_directory_given = 1;
		  args_info->target_directory_given = 1;
		  if (args_info->target_directory_arg)
			free (args_info->target_directory_arg); /* free previous string */
		  args_info->target_directory_arg = gengetopt_strdup (optarg);
		  if (args_info->target_directory_orig)
			free (args_info->target_directory_orig); /* free previous string */
		  args_info->target_directory_orig = gengetopt_strdup (optarg);
		  break;

		case 'T':	/* treat LINK_NAME as a normal file.  */
		  if (local_args_info.no_target_directory_given)
			{
			  fprintf (stderr, "%s: `--no-target-directory' (`-T') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
			  goto failure;
			}
		  if (args_info->no_target_directory_given && ! override)
			continue;
		  local_args_info.no_target_directory_given = 1;
		  args_info->no_target_directory_given = 1;
		  break;

		case 'V':	/* print name of each linked file.  */
		...
		case 'c':	/* Create a cygwin symbolic link instead of a native Win32 symbolic link. (Assumes -s).  */
		  if (local_args_info.cyglink_given)
			{
			  fprintf (stderr, "%s: `--cyglink' (`-c') option given more than once%s\n", argv[0], (additional_error ? additional_error : ""));
			  goto failure;
			}
		  if (args_info->cyglink_given && ! override)
			continue;
		  local_args_info.cyglink_given = 1;
		  args_info->cyglink_given = 1;
		  break;
